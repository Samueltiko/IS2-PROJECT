 <!DOCTYPE html>
    ...
    <head>
        ...
        <title>Chemkan Fashions Website</title>
    </head>
    <body>
        <!--==================== HEADER ====================-->
            ...
            <section class="home" id="home">
                <div class="home__container container grid">
                    <div class="home__img-bg">
                        <img src="assets/img/product1.png" alt="" class="home__img">
                    </div>
                    ...
                    <div class="home__data">
                        <h1 class="home__title">NEW FASHION <br> COLLECTIONS </h1>
                        <p class="home__description">
                            Latest arrival of the new imported fashions of the Air Jordan series, 
            ...
            <section class="featured section container" id="featured">
                ...
                <div class="featured__container grid">
                    <article class="featured__card">
                        ...
                        <img src="assets/img/featured1.jpg" alt="" class="featured__img">
                    ...
                    <article class="featured__card">
                        ...
                        <div class="featured__data">
                            <h3 class="featured__title">TROUSER</h3>
                        ...
                        <div class="swiper-wrapper">
                            <div class="testimonial__card swiper-slide">
                                ...
                                <p class="testimonial__description">
                                    They are the best fashions that one acquires, also they are always with the latest 
                                ...
                                <div class="testimonial__perfil">
                                    <img src="assets/img/tiko.jpg" alt="" class="testimonial__perfil-img">
        
                                    <div class="testimonial__perfil-data">
                                        <span class="testimonial__perfil-name">Tikodak</span>
                            ...
                            <div class="testimonial__card swiper-slide">
                                ...
                                <div class="testimonial__perfil">
                                    <img src="assets/img/keche.jpg" alt="" class="testimonial__perfil-img">
        
                                    <div class="testimonial__perfil-data">
                                        <span class="testimonial__perfil-name">Frank Kechee</span>
                            ...
                            <div class="testimonial__card swiper-slide">
                                ...
                                <div class="testimonial__perfil">
                                    ...
                                    <div class="testimonial__perfil-data">
                                        <span class="testimonial__perfil-name">Kiuta Benjamin</span>
                                        <span class="testimonial__perfil-detail">Director of a company</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper new-swiper">
                        <div class="swiper-wrapper">
                            <article class="new__card swiper-slide">
                                ...
                                <div class="new__data">
                                    <h3 class="new__title">T-SHIRT</h3>
                                    <span class="new__price">ksh 980</span>
                                </div>
                            ...
                            <article class="new__card swiper-slide">
                                ...
                                <div class="new__data">
                                    ...
                                    <span class="new__price">ksh 2500</span>
                                </div>
                            ...
                            <article class="new__card swiper-slide">
                                ...
                                <img src="assets/img/new3.jpg" alt="" class="new__img">
        
                                <div class="new__data">
                                    <h3 class="new__title">Blouses</h3>
                                    <span class="new__price">ksh 750</span>
                            ...
                            <article class="new__card swiper-slide">
                                ...
                                <img src="assets/img/new4.jpg" alt="" class="new__img">
        
                                <div class="new__data">
                                    <h3 class="new__title">TROUSER</h3>
                                    <span class="new__price">ksh 1500</span>
                                </div>
        ...
        <footer class="footer section">
            <div class="footer__container container grid">
                ...
                <div class="footer__content">
                    ...
                    <ul class="footer__links">
                        <li>
                            <a href="#" class="footer__link">Shirts</a>
                        </li>
                        <li>
                            <a href="#" class="footer__link">Trousers</a>
                        </li>
                        <li>
                            <a href="#" class="footer__link">Blouses</a>
                        </li>
                        <li>
            ...
            <span class="footer__copy">&#169; Chemkancode. All rigths reserved</span>
        </footer>
